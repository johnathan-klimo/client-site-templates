<div class="mt-16">
  <div>
    <h2 class="text-2xl text-center font-bold text-sky-800">Our Services [Option 1]</h2>
  </div>
  <div class="mt-8">
    <div class="grid grid-cols-3 gap-6">
      <x-app-themes.theme-testing-service-card-1
        serviceIconName="sun"
        :serviceIconSize="14"
      ...
      />
      <x-app-themes.theme-testing-service-card-1
        serviceIconName="building-with-check"
        :serviceIconSize="14"

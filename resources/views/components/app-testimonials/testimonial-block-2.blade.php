<div class="mt-16">
  <div>
    <h2 class="text-2xl text-center font-bold text-sky-800">Client Testimonials [Option 2]</h2>
  </div>
  <div class="mt-6">
    <div class="grid grid-cols-3 gap-6">
      <x-app-testimonials.testimonial-card-2
      ...
      <x-app-testimonials.testimonial-card-2
        ...
        text="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit vitae aliquam expedita? Ullam fugit repellendus sit error consequuntur quas fuga!"
        clientName="Harry B."
        starRating="5"
      />
      <x-app-testimonials.testimonial-card-2
        fileName="professional-headshot-3"
        text="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vitae repellendus praesentium dicta hic nobis dolorum blanditiis earum recusandae officiis eius?"

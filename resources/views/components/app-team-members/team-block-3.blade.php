<div class="mt-16">
  <div>
    <h2 class="text-2xl text-center font-bold text-sky-800">Our Team [Option 3]</h2>
  </div>
  <div class="mt-8">
    <div class="grid grid-cols-2 gap-x-10 gap-y-14">
      <x-app-team-members.team-card-3
        fileName="professional-headshot-6-large"
        teamMemberName="Gabriela C."
        teamMemberTitle="Co-Founder & CEO"
        teamMemberBio="Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis perspiciatis voluptas deleniti neque eum dolorem explicabo maiores harum tempore."
      />
      <x-app-team-members.team-card-3

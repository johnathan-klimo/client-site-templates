      ...
      <div class="m-auto  max-w-full max-lg:min-w-fit lg:max-w-96  flex justify-center">
        <div class="w-full">
          <ui-disclosure-group class="block" transition="transition" data-flux-accordion-heading>
            <ui-disclosure
              class="block pt-4 first:pt-0 pb-4 last:pb-0 border-b last:border-b-0 border-zinc-800/10"
              x-data="{ open: false }"
              x-model.self="open"
            ...
            >
              <button type="button" class="group/accordion-heading flex items-center w-full text-start text-sm font-medium justify-between [&amp;&gt;svg]:ms-6 text-zinc-800 dark:text-white cursor-pointer"  data-flux-accordion-heading>
                ...
                <svg class="shrink-0 [:where(&amp;)]:size-5 text-zinc-300 group-hover/accordion-heading:text-zinc-800 hidden group-data-open/accordion-heading:block text-zinc-800! dark:text-white!" aria-hidden="true" data-flux-icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                  <path fill-rule="evenodd" d="M9.47 6.47a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 1 1-1.06 1.06L10 8.06l-3.72 3.72a.75.75 0 0 1-1.06-1.06l4.25-4.25Z" clip-rule="evenodd"/>
                </svg>

                <svg class="shrink-0 [:where(&amp;)]:size-5 text-zinc-300 group-hover/accordion-heading:text-zinc-800 block group-data-open/accordion-heading:hidden" aria-hidden="true" data-flux-icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
